...
const teamMembers = [
  ...
  },
  {
    ...
    role: "Co-founder",
    description: "Rishav brings over five years of experience in finance, with a strong focus on the securities market and taxation. As a qualified Chartered Accountant with certification in accounts and finance from ICAI, he currently manages tax compliance matters.",
  },
  {
    name: "Anuj Kumar",
    ...
    role: "Secretarial & Compliances",
    description: "Anuj boasts over 10 years of experience in company law and secretarial matters, with exceptional expertise in handling company-related issues. As a practicing Company Secretary with certification in company and secretarial compliance from ICSI, he currently oversees legal and secretarial compliance.",
  },
  {
    name: "Rahul Keshri",
    image: "https://img.freepik.com/free-photo/portrait-successful-man-having-stubble-posing-with-broad-smile-keeping-arms-folded_171337-1267.jpg?ga=GA1.1.2000051094.1716005427&semt=ais_hybrid",
    role: "Technical Analyst",
    description: "Rahul brings over 5+ years of experience as a Technical Analyst, with a deep specialization in momentum and breakout trading, as well as volatility and liquidity-based strategies across equity, commodity, and currency markets. In an era increasingly dominated by AI and machine learning, Rahul remains a staunch advocate for traditional analysis methods, believing that timeless, hands-on techniques offer unparalleled insights and value in today's fast-paced trading environment.",
  },
  {
    name: "Amit Singh",
    image: "https://img.freepik.com/free-photo/young-bearded-man-with-striped-shirt_273609-5677.jpg?ga=GA1.1.2000051094.1716005427&semt=ais_hybrid",
    role: "Digital Branding Partner",
    description: "Amit is an expert in digital branding and marketing, with a focus on enhancing brand visibility through innovative online strategies.",
  },
];
          ...
          {teamMembers.map((member, index) => (
            <div key={index} className="p-4">
              ...
              >
                ...
                <p className="text-sm text-gray-600 leading-none mt-2">{member.role}</p>
